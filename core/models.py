...
class Product(models.Model):
    ...
    suggested_price = models.DecimalField(
        "Preço Sugerido", max_digits=10, decimal_places=2
    )
    lifecycle = models.CharField(
        "Ciclo de Vida", max_length=20, choices=LIFECYCLE_CHOICES, default="Stable"
    )
...
class OrderItem(models.Model):
    ...
    discount_applied = models.DecimalField(
        "Desconto Aplicado", max_digits=5, decimal_places=2, default=0
    )
